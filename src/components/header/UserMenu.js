            ...
            {(popupState) => (
                <React.Fragment>
                    <div {...bindTrigger(popupState)}>
                        <img src={userInfo.avatarUrl ? userInfo.avatarUrl : defAvatar} alt="Avatar" className={classes.userAvatar}/>
                    </div>
                    <Menu {...bindMenu(popupState)}>
                        ...
                        <MenuItem onClick={popupState.close}>
                            <Link className={classes.popupMenuLink} to={USER_PROFILE_ROUTE}>Profile</Link>
                        </MenuItem>
                        <MenuItem onClick={popupState.close}>
                            <span className={classes.popupMenuLink} onClick={onLogOutHandler}>Log Out</span>
                        </MenuItem>
                    </Menu>
                </React.Fragment>
            )}
