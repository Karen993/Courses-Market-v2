...
import {CourseNameTextField, DescriptionTextField, ImageUrlTextField, PriceTextField} from "./customizedTextFields";
            ...
            <div className={classes.container}>
                ...
                <form onSubmit={handleSubmit} className={classes.form}>
                    <div className={classes.textFieldBlock}>
                        ...
                        <CourseNameTextField value={courseName} onChange={e => setCourseName(e.target.value)}/>
                    </div>
                    <div className={classes.textFieldBlock}>
                    ...
                    <div className={classes.textFieldBlock}>
                        ...
                        <ImageUrlTextField value={imageUrl} onChange={e => setImageUrl(e.target.value)}/>
                    </div>
                    <div className={classes.textFieldBlock}>
                        <span className={classes.text}>Price ($): </span>
                        <PriceTextField type='number' value={price} onChange={e => setPrice(e.target.value)}/>
                    </div>
                    ...
                    <div className={classes.buttonSection}>
                        <StyledButton variant="contained" type="submit">Add Course</StyledButton>
                    </div>
