...
import {DELETE_BTN_COLOR, PAGE_PRIMARY_COLOR} from "../../../constants/colors";
    ...
    return (
        <div className={classes.container}>
            ...
            <span className={classes.priceIconsBlock}>
                ...
                <InfoIcon sx={{color: PAGE_PRIMARY_COLOR, cursor: 'pointer'}} onClick={onInfoBtnClick}/>
                <DeleteIcon sx={{color: DELETE_BTN_COLOR, cursor: 'pointer'}} onClick={() => onDelete(product.productID)}/>
            </span>
        </div>
    )
}