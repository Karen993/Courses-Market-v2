    ...
    return (
        <div className={classes.wrapper}>
            <form onSubmit={handleSubmit} className={classes.form}>
                <InputTextField label="Email" value={email} onChange={e => setEmail(e.target.value)}/>
                <InputTextField label="Username" value={userName} onChange={e => setUserName(e.target.value)}/>
                <InputTextField label="Avatar url" value={avatarUrl} onChange={e => setAvatarUrl(e.target.value)}/>
                <InputTextField label="Password" value={password} onChange={e => setPassword(e.target.value)}/>
                ...
                <div className={classes.buttonSection}>
                    <StyledButton variant="contained" type="submit">Create Account</StyledButton>
                </div>
