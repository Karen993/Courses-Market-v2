...
function getTabStyles(isActive, position) {
    ...
    const textColor = isActive ? AUTH_ACTIVE_TAB_TEXT_COLOR: AUTH_PASSIVE_TAB_TEXT_COLOR;
        ...
        <div className={classes.wrapper}>
            <div className={classes.container}>
                <div className={classes.header}>
                    <div style={getTabStyles(showSignIn, 'left')} onClick={() => setShowSignIn(true)}>
                        Log In
                    </div>
                    <div style={getTabStyles(!showSignIn, 'right')} onClick={() => setShowSignIn(false)}>
                        Register
                    </div>
                </div>
